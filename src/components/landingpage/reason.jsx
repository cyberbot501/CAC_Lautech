...
export default function reason() {
  ...
  return (
    <div className='bg-[#363133] flex flex-col justify-center items-center py-20'>
       <div className='flex flex-col justify-center items-center gap-5'>
            <h3 className='text-[#E9DCBE] font-Inter font-medium text-[18px] md:text-[25px]'>Why You should Join us</h3>
            <h1 className='text-[#F3F3F3] font-Cinzel font-semibold md:text-[40px] text-[25px] w-[300px] text-center'>EMBACK ON A JOURNEY OF FAITH AND SERVICE WITH US</h1>
       </div>
