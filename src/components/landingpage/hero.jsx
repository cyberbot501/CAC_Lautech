...
export default function hero() {
  return (
    <div className='hero flex flex-col justify-center items-center md:items-start h-[100vh] w-[100%] px-20 gap-6 pt-14'>
        ...
        <h2 className='md:w-[701px] text-center md:text-left text-white text-[15px] md:text-[20px] font-Inter font-semibold'>We believe that everyone is invited to experience God's grace, and that means you! Our church is a place where you can connect with others who share valueand beliefs, and where you can grow in your relationship with God.</h2>
